...
const Footer = () => {
  ...
  return (
    <footer className="bg-guru-dark text-white py-12 px-4 md:px-8">
      <div className="container mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">GURU</h3>
            <p className="text-gray-400 mb-4">
              Connecting students and tutors through intelligent matching.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Tutor Resources</a></li>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© {currentYear} Guru. All rights reserved.</p>
